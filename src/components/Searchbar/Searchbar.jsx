    ...
    <div className='mt-[15.5rem] w-full bg-[#FFFFFF] rounded-xl'>
      ...
      <form>
        <div className='mx-12'>
          ...
          <br />
          <input className='my-12 w-full bg-[#D9D9D9] rounded-xl py-2' type='text' id='experience' name='experience' />
          <br />
          <label htmlFor='degree'>給料 ( まで)</label>
          <br />
          <input className='my-12 w-full bg-[#D9D9D9] rounded-xl py-2' type='text' id='degree' name='degree' />
          <br />
          <label htmlFor='age'>年齢 ( まで)</label>
          <br />
          <input className='my-12 w-full bg-[#D9D9D9] rounded-xl px-5 py-2' type='text' id='age' name='age' />
        </div>
