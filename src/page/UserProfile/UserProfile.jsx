  ...
  return (
    <div className='w-full bg-[#DCEAFF]'>
      <div className='mx-16 font-itim py-10'>
        <form action=''>
          <div className='mt-10 grid gap-x-0 h-[40rem]'>
            ...
            <div className='bg-[#FFFFFF] rounded-3xl col-start-5 row-start-1 col-span-5 border-2 border-[#B9BFC9]'>
              ...
              <div className='ml-24 mr-32'>
                ...
                <div className='grid gap-y-28 mt-32 ml-16'>
                  ...
                  <input
                    className='inputedit col-start-2 col-span-2 border rounded-xl border-black py-1'
                    disabled
                    // {...register('email')}
                  ></input>
                  <div className='col-span-1 row-start-2 col-start-1'>住所 :</div>
                  <input
                    className='inputedit col-start-2 col-span-2 border rounded-xl border-black py-1'
                    disabled
                    // {...register('address')}
