      ...
      {payment && (
        <div>
          <div className=' bg-[#DCEAFF] flex justify-center items-center flex-col'>
            ...
            <div className='w-[90%] bg-[#FFF] mt-12 mb-24 rounded-3xl p-32'></div>
          </div>
          <div className='flex w-[90vw] h-[200vh] m-auto'>
            <div className='flex flex-auto w-64 bg-[#245878]'>
              <div className='flex-1 m-5 bg-[#FFF] p-12'>
                <div className='flex flex-row'>
                  ...
                  <div className='ml-auto w-[12rem]'>67 Le Thanh Nghi, Hai Ba Trung, Ha Noi</div>
                </div>
            ...
            <div className='flex flex-1 flex-col bg-[#451589]'>
              <div className='flex-1 m-5 bg-[#236589]'>
                <div></div>
              </div>
              <div className='flex-1 m-5 bg-[#548789]'></div>
            </div>
          </div>
          <div>
